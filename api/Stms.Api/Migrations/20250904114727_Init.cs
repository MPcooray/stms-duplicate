        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stroke = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimingMs = table.Column<int>(type: "int", nullable: false),
                    Heat = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "Code", "Distance", "Name", "Stroke" },
                values: new object[,]
                {
                    { 1, "50FR", 50, "50m Freestyle", "Freestyle" },
                    { 2, "100FR", 100, "100m Freestyle", "Freestyle" },
                    { 3, "100BK", 100, "100m Backstroke", "Backstroke" }
                });
